...
function App() {
  ...
  const handleDirectAccess = async (role) => {
    ...
    try {
      ...
      toast.error('Direct access failed. Please try again.');
    } finally {
      setLoading(false);
    }
  };
                ...
                <main className="flex-1 overflow-x-hidden overflow-y-auto bg-adaptive-bg">
                  <div className="container mx-auto px-6 py-8">
                    <Routes>
                      ...
                      <Route path="/drivers" element={<DriversManagement user={user} />} />
                      <Route path="/maintenance" element={<MaintenanceManagement user={user} />} />
